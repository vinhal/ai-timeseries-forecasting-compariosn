...
def exec(
    path='1_random-forest_kdn_univariate_one-step_regression',
    bootstrap=True,
    n_estimators=200,
    max_features='auto',
    max_depth=30,
    ...
    # path = '1_svr_kdn_univariate_one-step_regression'
...
for i in range(1, 11):
    exec(
        path=f'1_random-forest_kdn_univariate_one-step_regression_{i}',
        bootstrap=True,
        n_estimators=200,
        max_features='auto',
        max_depth=30,
