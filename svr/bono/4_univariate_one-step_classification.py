...
def exec(
    path='4_svr_bono_univariate_one-step_classification',
    kernel='rbf',
    degree=3,
    gamma=1,
    C=0.1,
    ...
    model = SVC(kernel=kernel, gamma=gamma, C=C, degree=degree, verbose=1)
...
for i in range(1, 11):
    exec(
        path=f'4_svr_bono_univariate_one-step_classification_{i}',
        kernel='poly',
        degree=6,
        gamma=0.01,
        C=10,
